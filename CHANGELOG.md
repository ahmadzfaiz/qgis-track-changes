...
- Cmon
  ([`44eb165`](https://github.com/ahmadzfaiz/qgis-track-changes/commit/44eb165a2f1180f58ee26a76078e0f807aabb296))

- Cmon changelog
  ([`604dae3`](https://github.com/ahmadzfaiz/qgis-track-changes/commit/604dae35854ff77052cd420f4fdc3ae5c8f3ed8c))

- Cmon, please work
  ([`e764e72`](https://github.com/ahmadzfaiz/qgis-track-changes/commit/e764e723f17440787859f3830c38b41661b399ea))
...
- Hope this work
  ([`cedd78e`](https://github.com/ahmadzfaiz/qgis-track-changes/commit/cedd78e58975bfcce5a3e8240ac6baa8c6cd60a0))

- Let use all branch
  ([`0021ffb`](https://github.com/ahmadzfaiz/qgis-track-changes/commit/0021ffbf220c8547185e2bd26d557c3aba0b5fa2))
...
- Please
  ([`82a29d2`](https://github.com/ahmadzfaiz/qgis-track-changes/commit/82a29d2ea9592681aa78fb132e4565b094c1f67c))

- Please changelog
  ([`45c430a`](https://github.com/ahmadzfaiz/qgis-track-changes/commit/45c430a836cf5991b22db88f88e292531a94c0be))
...
- Test
  ([`27f25da`](https://github.com/ahmadzfaiz/qgis-track-changes/commit/27f25da1f85cfa51113725c33767c15f888ea17b))

- Test version change with fix
  ([`df8b02a`](https://github.com/ahmadzfaiz/qgis-track-changes/commit/df8b02a02ac83a3b8a477237c7134b5a17180b11))
...
- Fix semantic version actions
  ([`9aff202`](https://github.com/ahmadzfaiz/qgis-track-changes/commit/9aff202693befe7ca45be4530cfeea02419155bf))

- **release**: Enable all branches for change version
  ([`e96816d`](https://github.com/ahmadzfaiz/qgis-track-changes/commit/e96816d4ba2e30ea033aeb826d157bf26a0d7884))

- **release**: Fix version changes in all branches
  ([`52c6158`](https://github.com/ahmadzfaiz/qgis-track-changes/commit/52c6158e83d9456a44bf1eb3f2620f0a9dde514f))

- **release**: Update CI/CD to detect any version changes in all branch except main
  ([`407abf0`](https://github.com/ahmadzfaiz/qgis-track-changes/commit/407abf0db184773629f062f24f4917b7eae3da2f))
